...
import Router from "./views/router.js"; // imports the router object from the router file 
...
app.use(Router); // tell the app to use the router for the functionality when a user sends a request
